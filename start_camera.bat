...
echo      https://spiritual-depletion-squint.ngrok-free.dev
echo   4. Set Camera Feed URL to:
echo      https://spiritual-depletion-squint.ngrok-free.dev/video_feed
echo ============================================
echo.

ngrok http 8000 --domain=spiritual-depletion-squint.ngrok-free.dev
